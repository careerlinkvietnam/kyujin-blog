...
async function createArticle() {
  const newContent = fs.readFileSync('draft/vietnam-foreign-investment-regulations-2026.html', 'utf8');

  console.log('=== Creating New Article: ベトナム外資規制・投資法ガイド2026 ===');
  ...
  const postData = JSON.stringify({
    title: 'ベトナム外資規制・投資法完全ガイド2026【業種別の出資比率制限と投資手続き】',
    content: newContent,
    status: 'publish',
    categories: [25, 148, 530]  // ベトナム(25), ビジネス(148), 投資(530)
  });
