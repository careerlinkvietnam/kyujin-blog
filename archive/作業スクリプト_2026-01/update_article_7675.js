...
async function updateArticle() {
  const newContent = fs.readFileSync('draft/overseas-job-inexperienced-guide-2026.html', 'utf8');

  console.log('=== Updating Article 7675: 未経験から海外転職 ===');
  ...
  const postData = JSON.stringify({
    title: '未経験から海外転職を成功させる完全ガイド2026【職種・国別・準備から内定まで】',
    content: newContent,
    status: 'publish',
  ...
  const postOptions = {
    ...
    path: '/blog/wp-json/wp/v2/posts/7675',
    method: 'POST',
    headers: {
      'Authorization': AUTH,
