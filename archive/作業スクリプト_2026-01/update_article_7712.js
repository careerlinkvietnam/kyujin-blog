...
async function updateArticle() {
  const newContent = fs.readFileSync('draft/50s-overseas-job-guide-2026.html', 'utf8');

  console.log('=== Updating Article 7712: 50代からの海外転職完全ガイド ===');
  ...
  const postData = JSON.stringify({
    title: '50代からの海外転職完全ガイド2026【国別・ポジション別・成功事例】',
    content: newContent,
    status: 'publish',
  ...
  const postOptions = {
    ...
    path: '/blog/wp-json/wp/v2/posts/7712',
    method: 'POST',
    headers: {
      'Authorization': AUTH,
