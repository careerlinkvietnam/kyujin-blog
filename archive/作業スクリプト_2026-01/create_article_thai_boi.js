...
async function createArticle() {
  const newContent = fs.readFileSync('draft/thailand-boi-investment-incentives-2026.html', 'utf8');

  console.log('=== Creating New Article: タイBOI投資恩典ガイド2026 ===');
  ...
  const postData = JSON.stringify({
    title: 'タイBOI投資恩典完全ガイド2026【法人税免除・関税免除の活用法】',
    content: newContent,
    status: 'publish',
