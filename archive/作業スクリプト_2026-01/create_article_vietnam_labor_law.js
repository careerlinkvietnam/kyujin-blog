...
async function createArticle() {
  const content = fs.readFileSync('draft/vietnam-labor-law-employment-guide.html', 'utf8');

  const articleData = JSON.stringify({
    title: '【2025-2026年版】ベトナム労働法・外国人雇用規制ガイド｜労働許可証・社会保険・解雇規制',
    content: content,
    status: 'publish',
    slug: 'vietnam-labor-law-employment-guide',
    categories: [],
    tags: []
  });

  console.log('Creating new article...');
  console.log('Title: 【2025-2026年版】ベトナム労働法・外国人雇用規制ガイド｜労働許可証・社会保険・解雇規制');
  console.log('Slug: vietnam-labor-law-employment-guide');
