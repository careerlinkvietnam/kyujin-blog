...
async function createArticle() {
  const newContent = fs.readFileSync('draft/thailand-japanese-companies-automotive-2026.html', 'utf8');

  console.log('=== Creating New Article: タイ日系企業動向・自動車産業2026 ===');
  console.log('Content length:', newContent.length, 'characters');

  const postData = JSON.stringify({
    title: 'タイ日系企業動向・自動車産業完全ガイド2026【EVシフトと求人動向】',
    content: newContent,
    status: 'publish',
    categories: [26, 148, 530]  // タイ(26), ビジネス(148), 投資(530)
  });
