...
const content = fs.readFileSync('C:\\Users\\siank\\Desktop\\ClaueCode\\drafts\\indonesia-japanese-companies-ranking-2026.html', 'utf8');

const data = JSON.stringify({
  title: 'インドネシアの日系企業ランキング【2026年最新】売上TOP20・業種別リスト',
  slug: 'indonesia-japanese-company-ranking',
  status: 'draft',
