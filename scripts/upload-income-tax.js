...
const content = fs.readFileSync('C:\\Users\\siank\\Desktop\\ClaueCode\\drafts\\indonesia-income-tax-guide-2026.html', 'utf8');

const data = JSON.stringify({
  title: 'インドネシアの個人所得税ガイド【2026年最新】税率・控除・確定申告を解説',
  slug: 'indonesia-income-tax-guide',
  status: 'draft',
