...
async function updateArticle() {
  const newContent = fs.readFileSync('draft/singapore-job-complete-guide-2026.html', 'utf8');

  console.log('=== Updating Article 7730: シンガポール転職完全ガイド ===');
  ...
  const postData = JSON.stringify({
    title: 'シンガポール転職完全ガイド2026【求人・給与・EP/Sパス・生活費を徹底解説】',
    content: newContent,
    status: 'publish',
    categories: [368, 148]  // シンガポール(368), ビジネス(148)
  });

  const postOptions = {
    hostname: 'kyujin.careerlink.asia',
    path: '/blog/wp-json/wp/v2/posts/7730',
    method: 'POST',
    headers: {
      'Authorization': AUTH,
