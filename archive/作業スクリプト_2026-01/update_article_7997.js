...
async function updateArticle() {
  const articleId = 7997;
  const newTitle = '【2025-2026年版】タイ最低賃金完全ガイド｜改定内容・地域別一覧・日系企業への影響';
  const newSlug = 'thailand-minimum-wage-guide-2025';
  const newContent = fs.readFileSync('draft/thailand-minimum-wage-2025.html', 'utf8');
